...
// Memulai Session
  ...
  if (isset($_POST['submit'])) {
    // Membuat variabel untuk menampung data dari FORMULIR EDIT USERS
    ...
    $query  = "UPDATE users SET level = '$level', username = '$username', name = '$name', email = '$email', password = '$password'";
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Silahkan perubahan data anggota yang kamu inginkan</p>
                        </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="InputEmail" name="email"
                                            aria-describeby="emailHelp" value="<?php echo $data['email']; ?>">
                                    </div>
                                    <div class="form-group">
