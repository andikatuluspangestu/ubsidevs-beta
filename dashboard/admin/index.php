    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
               <h3>Halo, Admin 👋 <script type="text/javascript">
                    //<![CDATA[
            ...
            <div class="page-content">
                ...
                <?php 
                    ...
                    $data_admin = mysqli_query($con,"SELECT * FROM users WHERE level = 'admin'"); 
                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0"><?php echo $jumlah_admin; ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table mb-2 table-lg">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-danger" href="../admin/index.php?delete=<?php echo $data['id']; ?>">
