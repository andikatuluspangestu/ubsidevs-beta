                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">List Artikel yang terdaftar di UBSI Tegal Devs Community</p>
                        </div>
                                            ...
                                            <table class="table mb-2 table-lg">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-danger" href="../admin/list_artikel.php?delete=<?php echo $data['id']; ?>">
