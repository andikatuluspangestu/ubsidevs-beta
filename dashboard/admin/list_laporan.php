...
<?php
  ...
  if( !isset($_SESSION['username']) ){
    ...
    if(isset($_GET['delete'])) {
      $id = $_GET['delete'];
      $query = mysqli_query($con, "DELETE FROM laporan WHERE id='$id'");
      header("Location: ../admin/list_laporan.php");
    }
  }
                                            ...
                                            <table class="table mb-2 table-lg">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $sql = "select id, judul, isi,pelapor, status from laporan order by id asc";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-danger" href="../admin/list_laporan.php?delete=<?php echo $data['id']; ?>">
                                                               <i class="bi bi-trash"></i>
                                                            </a>
                                                            <a class="btn btn-sm btn-danger" href="../admin/edit_status_laporan.php?id=<?php echo $data['id']; ?>">
