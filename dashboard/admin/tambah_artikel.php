                            ...
                            <div class="card">
                                ...
                                <?php
                                        ...
                                        if(move_uploaded_file($tmp, $path)) {
                                            $sql = "insert into t_artikel (author, judul,gambar,isi) values ('$author','$judul','$gambarbaru','$isi')";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <input class="form-control" type="text" name="author" value="<?= $_SESSION['username']; ?>" hidden />
                                    <div class="mb-3">
                                        <label for="judulArtikel" class="form-label">Judul Artikel</label>
                                        <input class="form-control" type="text" name="judul"
                                            placeholder="Article Title" id="judulArtikel" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div id="editor" class="mb-5">
                                        <label for="formFile" class="form-label">Tulis Artikel</label>
                                        <textarea name="isi" placeholder="Masukan artikel kamu disini"></textarea>
                                    </div>
                                    <!-- <div class="mb-3">
