<?php
    ...
    if (isset($_POST["add_post"])) {
        ...
        $sql = "insert into laporan (pelapor,judul,isi) values ('$pelapor','$judul','$isi')";
        ...
        if(!$hasil){
          ...
          echo "<script>window.location='../anggota/list_laporan.php';</script>";
        }
    }
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Silahkan masukan laporan kamu di halaman ini</p>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                    <div class="mb-3">
                                        <label for="judulArtikel" class="form-label">Judul Laporan</label>
                                        <input class="form-control" type="text" name="judul"
                                            placeholder="Laporan Title" id="judulArtikel" />
                                    <div class="mb-3">
                                    <label for="formArtikel" class="form-label">Deskripsi Laporan</label>
                                        <textarea id="editor" class="ckeditor border-0 rounded-3" name="isi" placeholder="Masukan laporan kamu disini"></textarea>
                                    </div>
