...
<?php
  ...
  if( !isset($_SESSION['username']) ){
    ...
    if(isset($_GET['delete'])) {
      ...
      header("Location: ../anggota/list_laporan.php");
    }
  }
                                            ...
                                            <table class="table mb-2 table-lg">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $sql = "select id, judul, isi, status from laporan where pelapor = '$pelapor' order by id asc";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- HTML Special Chars Decode untuk parse kode HTML -->
